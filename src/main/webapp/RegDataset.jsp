...
<div class="col-md-6">
<div ><center><h2>UPload Dataset</h2></center><br/>
 <form   action="http://localhost:80/OnlineHousePricePredictionPython/fileupload1.py" method="post"  enctype="multipart/form-data">
